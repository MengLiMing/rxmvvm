...
extension ContextExtension on BuildContext {
  ...
  ///
  /// 当 [ignoreContainer] 为 true 时，不查找自身的ViewModel，
  ...
  T? getViewModel<T extends ViewModel>({
    ...
    if (!ignoreContainer && this is ConsumerStatefulElement) {
      final result = (this as ConsumerStatefulElement).getViewModel<T>();
